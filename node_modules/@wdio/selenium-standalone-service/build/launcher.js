...
class SeleniumStandaloneLauncher {
    ...
    async onPrepare(config) {
        ...
        if (!this.skipSeleniumInstall) {
            await util_1.promisify(selenium_standalone_1.default.install)(this.installArgs);
        }
        (Array.isArray(this.capabilities)
            ? this.capabilities
            : Object.values(this.capabilities)).forEach((cap) => Object.assign(cap, DEFAULT_CONNECTION, { ...cap }));
        this.process = await util_1.promisify(selenium_standalone_1.default.start)(this.args);
